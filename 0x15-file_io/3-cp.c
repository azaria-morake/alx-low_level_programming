 ...
 * for a buffer to store characters from a file.
 * @file: The name of the file for which characters are being stored.
 *
 ...
 *   exits with code 97.
 * - If the 'file_from' does not exist or cannot be read,
 *   the program exits with code 98.
 * - If the 'file_to' cannot be created or written to,
